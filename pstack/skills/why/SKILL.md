...
Before spawning investigators, list the available MCPs in this session. Use the available-tools map when present. Otherwise inspect the MCP servers configured for this session.
